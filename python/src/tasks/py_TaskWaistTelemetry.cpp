...
void tasks_TaskWaistTelemetry(py::module & m)
{
    py::class_<TaskWaistTelemetry>(m, "TaskWaistTelemetry")
        ...
        .def_readwrite("counter", &TaskWaistTelemetry::counter)
        .def_readwrite("t_start", &TaskWaistTelemetry::t_start)
        .def_readwrite("t_end", &TaskWaistTelemetry::t_end)
        ...
        .def_readwrite("connected_devices", &TaskWaistTelemetry::connected_devices)
