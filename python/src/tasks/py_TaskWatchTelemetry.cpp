...
void tasks_TaskWatchTelemetry(py::module & m)
{
    py::class_<TaskWatchTelemetry>(m, "TaskWatchTelemetry")
        ...
        .def_readwrite("counter", &TaskWatchTelemetry::counter)
        .def_readwrite("t_start", &TaskWatchTelemetry::t_start)
        .def_readwrite("t_end", &TaskWatchTelemetry::t_end)
        .def_readwrite("invalid_checksum", &TaskWatchTelemetry::invalid_checksum)
    ...
    py::class_<TaskWatchTelemetry::Buffer>(m, "TaskWatchTelemetryBuffer")
        .def(py::init<>())
        .def_property_readonly("valid_checksum", &TaskWatchTelemetry::Buffer::valid_checksum)
        .def_property_readonly("buffer", [](const TaskWatchTelemetry::Buffer & b) {
