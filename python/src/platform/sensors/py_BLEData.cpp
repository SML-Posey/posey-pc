...
void platform_sensors_BLEData(py::module& m) {
        ...
        .def_property(
            ...
            [](BLEData& data) -> pybind11::array {
                ...
                auto base = pybind11::array(
                    dtype, {BLEData::uuid_len}, {sizeof(uint8_t)});
                return pybind11::array(
                    dtype, {BLEData::uuid_len}, {sizeof(uint8_t)}, data.uuid,
                    base);
            },
            [](BLEData& data, pybind11::array_t<uint8_t> new_data) {
                if (new_data.size() != BLEData::uuid_len)
                    throw std::invalid_argument(fmt::format(
                        "Must set to {:d} element vector!", BLEData::uuid_len));
    ...
    py::class_<BLEData::Buffer>(m, "BLEDataBuffer")
        ...
        .def_property_readonly(
            "valid_checksum", &BLEData::Buffer::valid_checksum)
